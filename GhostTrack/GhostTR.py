...
def weather_tracker():
    city = input(f"{Wh}\nEnter City Name: {Gr}")
    api_key = "04e4aa57a28a3e0f10633c4079e2099d"  
...
@is_option
def bug_whatsapp():
    number = input(f"{Wh}\nEnter the WhatsApp number to send a bug: {Gr}")
    print(f"{Wh}\nSending bug to WhatsApp number: {Gr}{number}...")
    time.sleep(2)
    print(f"{Wh}Bug successfully sent to {Gr}{number}{Wh}!")



@is_option
def banned_whatsapp():
    number = input(f"{Wh}\nEnter the WhatsApp number to ban: {Gr}")
    print(f"{Wh}\nProcessing ban for WhatsApp number: {Gr}{number}...")
    time.sleep(2)
    print(f"{Wh}{Re}Banned{Wh} WhatsApp number {Gr}{number} {Wh}successfully!")
...
options = [
 ...
 {
    'num': 7,
    'text': 'Banned WhatsApp',
    'func': banned_whatsapp
},
{
    'num': 8,
    'text': 'Bug WhatsApp',
